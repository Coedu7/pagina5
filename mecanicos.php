...
<!-- Formulario para ingresar altura y base -->
    <div style="width: 75vh; background-color: burlywood; padding: 1vh; position: absolute; top:25%; left: 25%; ">
        ...
        <a href="registromec.php">Registro de mecanicos</a>
        <table border="1" >
                <thead>
                    <tr>
                        <th>Cedula</th>
...
<script>
    ...
    function guardar(){
        ...
        if (!isNaN(cedula)) {
            var parametros = {"id": cedula, "nombre": nombre};
            $.ajax({
                url: "assets/modificarmec.php",
                type: "post",
                data: parametros,
            beforeSend: function() {
                $("#resultado").html("Procesando, espere por favor...");
